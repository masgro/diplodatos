...
b <- subset(flights, arr_delay > 120.0)
dim(b)[1]

- Volaron hacia Houston (IAH o HOU)

c <- subset(flights, dest == "IAH" | dest == "HOU")
dim(c)[1]

- Fueron operados por United, American o Delta.

d = subset(flights, carrier == "UA" | carrier == "AA" | carrier == "DL")
dim(c)[1]

- Salieron en Verano (Julio, Agosto y Septiembre)

e <- subset(flights,month == '7' | month == '8' | month == '9')

- Arrivaron mas de dos horas tarde, pero salieron bien.

f <- subset(flights, dep_delay == 0.0 | arr_delay > 120.0)
f <- subset(flights, dep_delay <= 0.0 | arr_delay > 120.0)

- Salieron entre medianoche y las 6 am.

g <- subset(flights, dep_time >= 0.0 | dep_time <= 600.0)spl
